...
function render() {
    ...
    // Categories & Datalist for typing
        ...
        <div class="bg-white p-4 rounded-3xl border border-slate-100 flex items-center gap-4">
            ...
            <div class="flex-1">
                ...
                <div class="flex items-center gap-2 mt-1">
                    <input type="text" list="category-list" value="${p.cat || 'Other'}" onchange="editItem(${p.id}, 'cat', this.value)" placeholder="Category" class="text-[9px] font-black uppercase text-slate-400 bg-slate-50 px-2 py-0.5 rounded-md outline-none">
